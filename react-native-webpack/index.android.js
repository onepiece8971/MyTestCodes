...
/***/ function(module, exports, __webpack_require__) {
	...
	var NativeWebpack = function (_Component) {
	    _inherits(NativeWebpack, _Component);

	    function NativeWebpack() {
	        _classCallCheck(this, NativeWebpack);

	        return _possibleConstructorReturn(this, Object.getPrototypeOf(NativeWebpack).apply(this, arguments));
	    }

	    _createClass(NativeWebpack, [{
	        key: 'render',
	    ...
	    return NativeWebpack;
	}(_react.Component);

	var styles = __webpack_require__(34);

	_reactNative.AppRegistry.registerComponent('NativeWebpack', function () {
	    return NativeWebpack;
	});
